        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                <form action="AllocatingServlet" method="post">
                    ...
                    <select class="form-control" id="formControlSelect1" size="8" name="<%=Category.INTERNAL_MODERATOR%>" multiple="multiple" required>
                        <%
                        for (int i = 0; i < internalModerators.size(); i++) {
                        User u = internalModerators.get(i);
                        if (internalModeratorSet.contains(u.getId())) {
                        %>
                        <option value="<%= u.getId()%>" selected="selected"><%=u.getFirstName() + " " + u.getLastName()%></option>
                        <%
                        } else {
                        %>
                    ...
                    <select class="form-control" id="formControlSelect2" size="8" name="<%=Category.EXAM_VETTING_COMMITTEE%>" multiple="multiple" required>
                        <%
                    ...
                    <select class="form-control" id="formControlSelect3" size="8" name="<%=Category.EXTERNAL_EXAMINER%>" multiple="multiple" required>
                        <%
